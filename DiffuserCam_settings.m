...
solverSettings.disp_figs = 100;   %If set to 0, never display. If set to N>=1, show every N.
solverSettings.print_interval = 100;  %Print cost every N iterations. Default 1. If set to 0, don't print.
